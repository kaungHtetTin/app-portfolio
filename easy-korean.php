...
<body>
    ...
    <section id="features" class="section-padding bg-light-custom">
        <div class="container">
            <h2 class="text-center section-title">Easy Korean Application Features</h2>
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box text-center">
                        ...
                        <p>
                            လစဉ် (သိုမဟုတ်) Course အလိုက်ပေးရတဲ့ စျေးကြီးတဲ့ သင်တန်းကြေးတွေအစား၊ Easy Korean App ရဲ့ သင်ခန်းစာအားလုံးကို <strong>၅၀,၀၀၀ ကျပ်</strong> ဖြင့်သာ <strong>တစ်သက်တာ (Lifetime Access)</strong> အသုံးပြုခွင့် ရယူနိုင်ခြင်း
                        </p>
                        <p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box text-center">
                        ...
                        <p> သင်ခန်းစာများအပြင်၊ ကိုရီးယားသီချင်းများကို <strong>ကိုရီးယား-မြန်မာ ၂ ဘာသာစာသားများဖြင့် </strong>နားထောင်ရင်း၊ စာလေ့လာနိုင်သော အခမဲ့ Feature တစ်ခုကို ထည့်သွင်းပေးထားခြင်း</p>
                        <p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-box text-center">
                        ...
                        <p>
                            <strong>အားသာချက်</strong> - ကိုယ့်ဘာသာကိုယ် Plan ဆွဲစရာမလိုဘဲ၊ App ရဲ့ လမ်းညွှန်မှုအတိုင်း နေ့စဉ် သင်ယူသွားရုံဖြင့် ကိုရီးယားစာကိုကျွမ်းကျင်တတ်မြောက်စေမှာပါ။
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="video-container">
                        <div style="padding:56.25% 0 0 0;position:relative;">
                            <iframe
                                ...
                                title="Easy Korean Honest Review"></iframe>
                        </div>
