        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4">Easy English application သည် မြန်မာလူငယ်များအတွက် အထူးဒီဇိုင်းပြုလုပ်ထားသော
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    <h2 class="mb-3">ယခုပဲ Easy English ကို စတင်သင်ယူလိုက်ပါ</h2>
                    <p class="lead mb-4">မြန်မာလူငယ်ထောင်ပေါင်းများစွာ ယခုပင် Easy English ဖြင့် ကိုရီးယားစကားကို
                        သင်ယူနေပါပြီ</p>
                    <div class="d-flex flex-wrap gap-3">
